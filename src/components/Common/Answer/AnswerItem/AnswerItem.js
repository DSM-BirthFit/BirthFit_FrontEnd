...
const AnswerItem = ({ commentId, content, isMine, userId, height, ySize, url, handleAnswerEditSubmit, handleAnswerDeleteSubmit }) => {
    ...
    return (
        <AnswerItemStyle.Container id={commentId}>
            <AnswerItemStyle.Header>
                ...
                {isMine && !edit &&
                    <AnswerItemStyle.Btn>
                        <AnswerItemStyle.Edit onClick={() => setEdit(!edit)}>수정하기</AnswerItemStyle.Edit>
